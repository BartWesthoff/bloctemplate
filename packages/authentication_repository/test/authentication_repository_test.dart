...
void main() {
  ...
  group('AuthenticationRepository', () {
    ...
    group('loginWithGoogle', () {
      ...
      test(
          'throws signInWithGoogleFailure and calls signIn authentication, and '
      ...
      test('throws signInWithGoogleFailure when exception occurs', () async {
        when(() => firebaseAuth.signInWithCredential(any()))
            .thenThrow(Exception());
        expect(
          authenticationRepository.signInWithGoogle(),
    ...
    group('signOut', () {
      ...
      test('throws SignOutFailure when signOut throws', () async {
    ...
    group('user', () {
      test('emits User.empty when firebase user is null', () async {
        ...
        await expectLater(
          ...
          emitsInOrder(const <AppUser>[AppUser.empty]),
        );
      });
      ...
      test('emits User when firebase user is not null', () async {
        ...
        await expectLater(
          authenticationRepository.user,
          emitsInOrder(const <AppUser>[user]),
        );
      });
    });
